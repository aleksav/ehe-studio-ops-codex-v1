...
- Reference the issue number in **every** commit. Always use your agent author identity:

```bash
git commit --author="developer-a-agent <aleksa@tsf.tech>" -m "feat: add user profile endpoint #NNN"
```
