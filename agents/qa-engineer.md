...
2. **Pick up QA issue**, create branch `qa/issue-NNN-e2e-feature-name`. Use your agent author identity on all commits: `git commit --author="qa-engineer-agent <aleksa@tsf.tech>" -m "test: ..."`
